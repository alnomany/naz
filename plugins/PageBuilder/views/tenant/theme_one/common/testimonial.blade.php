                            ...
                            <div class="slick-slider-items">
                                <div class="single-feedback-left">
                                    <div class="single-feedback-left-contents">
                                        ...
                                        <p class="single-feedback-left-contents-para-two mt-4"> {{\App\Helpers\SanitizeInput::esc_html($item->description)}} </p>
                                    </div>
                                </div>
                            </div>
                        @endforeach
                        ...
                        @foreach($data['testimonial'] ?? [] as $item)
                            ...
                            <div class="single-feedback-two">
                                <div class="single-feedback-two-contents">
                                    ...
                                    <p class="single-feedback-two-contents-para-two mt-3"> {{\App\Helpers\SanitizeInput::esc_html($item->description)}} </p>
                                    <div class="single-feedback-two-contents-bottom feedback-two-border">
                                        <div class="single-feedback-two-contents-bottom-flex">
                                            <div class="single-feedback-two-contents-bottom-details">
                                                <h3 class="single-feedback-two-contents-bottom-details-title mt-3"> <a href="javascript:void(0)"> {{\App\Helpers\SanitizeInput::esc_html($item->name)}} </a> </h3>
