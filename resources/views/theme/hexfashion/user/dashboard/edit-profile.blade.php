        ...
        <form action="{{route('tenant.user.profile.update')}}" method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="form-group col-lg-6">
                    ...
                    <input type="tel" class="form-control" id="phone" name="mobile" value="{{$user_details->mobile}}">
                </div>
                <div class="form-group col-lg-6">
                    <label for="address">{{__('Comapny')}}</label>
                ...
                <div class="form-group col-lg-6">
                    ...
                    <select id="country" class="form-control" name="country" style="height: 50px">
...
<x-media-upload.markup id="" :user-type="'user'"/>
@endsection
